...
<section id="aboutus">
 ...
 <div class="container">
   <h3 class="text-center"><br><br>JKMN Bakery</h3>
   <div class="row">
<!--carousel-->
...
<!--end of carousel-->
	...
	<p><br>Welcome to JKMN Cafe, where culinary dreams become reality. Our passionate chefs craft exquisite dishes using the finest ingredients. Experience our inviting space, where sophistication meets comfort. Indulge in a symphony of flavors that dance on your palate. Every bite reveals extraordinary creativity and precision. Beyond the food, forge connections and create cherished memories. Our warm staff ensures impeccable service. Join us for an extraordinary dining experience where dreams come true.<br><br><br></p><hr>
	</div>
     </div>
    </div><br>
  </div>
...
?>
            ...
            <p class="text-right">JKMN Bakery<br><i class="fa fa-map-marker"></i>&nbsp; Leof. Posidonos 109, <br>Glyfada <br><br>email: info@domain.com<br>phone: +00 (123) 456 7890</p>
            </div>
